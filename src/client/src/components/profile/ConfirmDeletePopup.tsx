    ...
    <div className="fixed inset-0 bg-white bg-opacity-50 z-[100] h-screen w-screen flex items-center justify-center">
      <div className="bg-darkGrey shadow-lg flex flex-col items-center rounded-xl overflow-hidden">
        <div className="flex flex-row justify-between items-center p-4 w-full space-x-5">
          <label className="font-mono font-semibold text-2xl text-white">Are You Sure?</label>
        ...
        <div className="flex flex-row items-center justify-center pb-6 pt-3 space-x-4">
          <button className="flex w-24 h-14 bg-red-600 hover:bg-red-700 active:bg-red-800 rounded-full items-center justify-center font-bold text-xl"
            onClick={handleDeleteClick}>
            YES
          </button>
          <button className="flex w-24 h-14 bg-gray-300 hover:bg-gray-400 active:bg-gray-500 rounded-full items-center justify-center font-bold text-xl"
