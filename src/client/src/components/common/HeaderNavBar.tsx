...
export default function HeaderNavBar() {
  ...
  async function userIsLoggedIn(id: string) {
    try {
            ...
            <div className="max-w-8xl mx-auto px-2 sm:px-4 lg:divide-y lg:divide-gray-700 lg:px-8">
              <div className="relative h-16 flex justify-between">
                ...
                {user ? (
                  ...
                  <div className="hidden lg:relative lg:z-10 lg:ml-4 lg:mr-2 lg:flex lg:items-center space-x-2">
                    <a href="/login">
                      <button className=" px-3 pb-[8px] pt-[10px] text-sm font-medium text-neutral-50 focus:border-neutral-100 focus:text-neutral-100 focus:outline-none focus:ring-0 active:border-neutral-200 active:text-neutral-200">
                        Sign In
                      </button>
                    </a>
                    <a href="/register">
                      <button className="rounded border-2 border-neutral-50 px-2 pb-[5px] pt-[5px] text-sm font-medium text-neutral-50  hover:border-neutral-100 hover:bg-neutral-500 hover:bg-opacity-10 hover:text-neutral-100 focus:border-neutral-100 focus:text-neutral-100 focus:outline-none focus:ring-0 active:border-neutral-200 active:text-neutral-200">
                        Register
                      </button>
                    </a>
                  </div>
