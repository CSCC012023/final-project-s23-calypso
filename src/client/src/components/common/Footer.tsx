...
const navigation = {
    ...
    social: [
      ...
      {
        name: 'Facebook',
        href: 'https://www.facebook.com/UofTScarborough/',
        icon: (props:any) => (
          <svg fill="currentColor" viewBox="0 0 24 24" {...props}>
            <path
              fillRule="evenodd"
  ...
  export default function Footer() {
    return (
      <footer className="bg-menu">
        <div className="max-w-7xl mx-auto py-8 px-4 overflow-hidden sm:px-6 lg:px-8">
          <nav className="-mx-5 -my-2 flex flex-wrap justify-center" aria-label="Footer">
            {navigation.main.map((item) => (
              <div key={item.name} className="px-5 py-2">
                <a href={item.href} className="text-base font-medium text-gray-400 hover:text-gray-200">
                  {item.name}
                </a>
              </div>
            ))}
          ...
          <p className="mt-8 text-center text-base text-gray-400">&copy; 2023 Calypso.  All rights reserved.</p>
        </div>
      </footer>
    )
  }
