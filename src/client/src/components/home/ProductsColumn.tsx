...
export default function ProductsRow( {productsList, categoryTitle}: Props ) {
    return (
        <div className="">
            <div className="py-48 lg:max-w-7xl sm:py-8 lg:py-24 lg:px-8">
            <div className="px-4 items-center justify-center mx-40 sm:px-6 lg:px-0">
                <h2 id="trending-heading" className="text-center text-6xl font-extrabold tracking-tight text-gray-100">
                    {categoryTitle}
                </h2>
            </div>
                ...
                {productsList.map((product: any) => (
                    <div key={product.id} className="my-4">
                        ...
                        <div className="flex justify-center mt-4 mb-24">
                            <button className="bg-gray-600 hover:bg-gray-800 text-white font-bold py-2 px-4 rounded mr-2">
                                Add to cart
                            </button>
