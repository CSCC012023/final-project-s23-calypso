        ...
        <form className='text-white w-full max-w-[500px] rounded-xl mx-auto p-8 px-8 space-y-8'>
          ...
          <div className='space-y-4'>
            <div>
                ...
                <input type="email" name="email" id="email" className="bg-black border-black text-gray-900 sm:text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full h-[3rem] p-2.5 " placeholder="John Doe"/>
            </div>
            <div>
            ...
            <div>
              ...
              <input type="password" name="password" id="password" placeholder="••••••••" className="bg-black border-black text-gray-900 sm:text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full h-[3rem] p-2.5"/>
            </div>
            <div>
          ...
          <div>
              <a type="submit" href="/login" className="w-full text-white bg-primary-600 hover:bg-primary-700 focus:ring-4 focus:outline-none focus:ring-primary-300 font-medium rounded-lg text-lg px-5 py-2.5 text-center">Register</a>
