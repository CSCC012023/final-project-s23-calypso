...
## User Stories (Tracked in JIRA) (max 10 marks) 
  ...
  - Estimated (max 2 marks)
    ...
    Your Mark: 0 (missing story point estimations)
  ...
  - Clearly Defined Acceptance Criteria (max 2 marks)
    ...
    Your Mark: 0 (acceptance criteria not on jira issues)
...
## Tracking on JIRA  (max 20 marks) 
  ...
  - Is the pull request done by the person to whom the task has been assigned to?  (max 2 marks)
    ...
    Your Mark: 1.5 (some issues were not assigned but completed (ie. CAL-44))
  ...
  - Is the git commit message clear? (max 2 marks)
    ...
    Your Mark: 1.5 (most commits have meaninful descriptions but none are linked back to what jira ticket is being worked on)
...
## Sprint Demo (Max 14 marks) 
  ...
  - Documentation (max 2 marks)
    ...
    Your Mark: 1 (add more comments, (eg. brief description for frontend components, etc))
